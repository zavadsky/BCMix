Program in the main.cpp encodes the sequence of integers with the reverse multi-delimiter code R2,4-infinity [1] and tests the speed of the fast decoding algorithm.
